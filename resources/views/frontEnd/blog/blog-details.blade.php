            ...
            <div class="row">
                <div class="col-md-9 post-content" data-aos="fade-up">
                    ...
                    <div class="single-post">
                        ...
                        <p><span class="firstcharacter">{{substr($blog->description,0,1)}}</span>{{substr($blog->description,1,255)}}</p>


                            <img src="{{asset($blog->image)}}" alt="" class="img-fluid">
                            <figcaption>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, odit? </figcaption>

                        <p>{{substr($blog->description,255)}}</p>
                ...
                <div class="col-md-3">
                    ...
                    <div class="aside-block">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <!-- Popular -->
                            @foreach($categoriesWiseBlogs as $categoriesWiseBlog)
                            <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                                <div class="post-entry-1 border-bottom">
                                    <img src="{{asset($blog->image)}}" alt="" class="img-fluid">
                                    <div class="post-meta"><span class="date">{{$categoriesWiseBlog->category_name}}</span> <span class="mx-1">&bullet;</span> <span>{{date("M js 'y",strtotime($categoriesWiseBlog->date))}}</span></div>
                                    <h2 class="mb-2"><a href="#">{{$categoriesWiseBlog->title}}</a></h2>
                                    <span class="author mb-3 d-block">{{$categoriesWiseBlog->author_name}}</span>
                                </div>
                                @endforeach
